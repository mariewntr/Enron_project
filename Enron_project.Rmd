...
- change the data type of the identifer variable from numeric to factor. 

- withdraw the message_id variable in the message table to lighten the dataset.
...
message_2 <- message %>%
  ...
  transform(mid = as.factor(mid)) #change the data type for factor
```
