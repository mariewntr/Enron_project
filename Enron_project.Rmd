...
rm(employeelist, message, message_2, recipientinfo, recipientinfo_2, referenceinfo)
```
...
### Exploring the email address to see if is it possible to link the table employeelist and df_message through it.
...
**SEE HOW TO CREATE A FUNCTION FOR MAKES A MERGING WITH THE 2 EMAIL ADDRESS VARIABLE** do it for the sender and the recipient. 
